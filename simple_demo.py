#!/usr/bin/env python3
"""
Simple CrisisSim Demo
This demo works directly without subprocess issues.
"""
...
async def main():
    """Main demo function."""
    print("🚨 CrisisSim Simple Demo")
    print("=" * 50)
    print("This demo uses the fallback version (no API key needed)")
    print("=" * 50)
    
    demo = SimpleCrisisSimDemo()
